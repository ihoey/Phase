...
struct TrafficDetailView: View {
    ...
    private var trendView: some View {
        VStack(spacing: Theme.Spacing.lg) {
            ...
            HStack(spacing: Theme.Spacing.md) {
                statCard(title: "7天总计", value: formatBytes(tracker.last7Days.reduce(0) { $0 + $1.totalBytes }))
    ...
    private func trafficItemCard(icon: String, title: String, subtitle: String, upload: Int64, download: Int64) -> some View {
        CardView {
            HStack(spacing: Theme.Spacing.md) {
                // 图标
